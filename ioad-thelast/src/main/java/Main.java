...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        for (int i = 0; i < 20; i++) {
            fiveAttempts.add(new KMeans(readTrainingData(training2), centroidsNumber));
        }

        MLP mlp = new MLP(readTrainingData(numbers), readTrainingData(training2), fiveAttempts.poll(),
